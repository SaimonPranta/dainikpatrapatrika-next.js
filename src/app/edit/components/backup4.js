  ...
  return (
    <div className="editor-container">
      <div className="toolbar">
        ...
        {/* Subscript Button */}
        <button onClick={toggleSubscript} className="toggle-subscript-btn">Subscript</button>

        {/* Superscript Button */}
        <button onClick={toggleSuperscript} className="toggle-superscript-btn">Superscript</button>
      ...
      <style jsx>{`
        ...
        .align-image-btn,
        .add-file-btn,
        .toggle-subscript-btn,
        .toggle-superscript-btn,
        .add-table-btn {
          margin-right: 10px;
          padding: 8px;
        ...
        .add-file-btn:hover,
        .toggle-subscript-btn:hover,
        .toggle-superscript-btn:hover,
        .add-table-btn:hover {
